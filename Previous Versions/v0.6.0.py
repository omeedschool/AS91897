...
class DataTable(ttk.Frame):
    ...
    def update_item(self):
        ...
        item = self.master.notebook.form.item_entry.get()
...
class Notebook(ttk.Notebook):
    def __init__(self, parent):
        ...
        self.form = Form(self)
        self.item_window = ItemTab(self)

        self.add(self.form, text='Menu')
        self.add(self.item_window, text='Items')
...
class ItemTab(ttk.Frame):
    ...
    def add_item_type(self):
        ...
        if not item.isalpha():
            messagebox.showwarning("Item type name should not contain numbers or symbols")
        else:
