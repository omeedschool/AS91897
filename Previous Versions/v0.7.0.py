...
class Form(ttk.Frame):
    ...
    def update_options(self):
        self.options = item_type_list

        for item in self.options:
            self.item_option_menu["menu"].add_command(
                label=item, command=tk._setit(self.clicked, item))
    ...
    def add_data(self):
        ...
        self.master.master.data_table.update_treeview(data_list)
...
class ItemTab(ttk.Frame):
    ...
    def add_item_type(self):
        ...
        if not item.isalpha():
            messagebox.showwarning(
                "Item type name should not contain numbers or symbols")
        else:
    ...
    def update_item_tree(self, treeview_data):
        ...
        self.update_options(treeview_data)

    def update_options(self, treeview_data):
        global item_type_list
        item_type_list = treeview_data
        self.master.form.update_options()
